...
if (isset($_POST['submit'])) {
	...
	if ($password == $cpassword) {
		...
		if (!$result->num_rows > 0) {
			$sql = "INSERT INTO login (fname, username, email, birthdate, occupation, password, unencrypted_password,  role)
					VALUES ('$fname', '$username','$email', '$birthdate','$occupation','$password', $unpassword, '3')";
			$result = mysqli_query($conn, $sql);
			if ($result) {
...
<body>
	<div class="container">
		<form action="" method="POST" class="login-email">
            <p class="login-text" style="font-size: 2rem; font-weight: 600; font: 2rem serif;">Sign up as Others</p>
